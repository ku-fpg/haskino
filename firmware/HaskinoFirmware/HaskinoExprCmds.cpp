...
static bool handleEval(int type, int size, const byte *msg, byte *local)
    ...
    switch (type)
        ...
        case EXPR_BOOL:
            ...
            boolResult = evalBoolExprOrBind(&expr, local);
        ...
        case EXPR_WORD8:
            ...
            word8Result = evalWord8ExprOrBind(&expr, local);
        ...
        case EXPR_WORD16:
            ...
            word16Result = evalWord16ExprOrBind(&expr, local);
        ...
        case EXPR_WORD32:
            ...
            word32Result = evalWord32ExprOrBind(&expr, local);
            memcpy(&reply[1], &word16Result, sizeof(word16Result));
