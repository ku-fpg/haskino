...
#define EXPR_FINT 0x03
#define EXPR_TINT 0x04
#define EXPR_NOT  0x05
#define EXPR_AND  0x06
#define EXPR_OR   0x07
#define EXPR_XOR  0x08
#define EXPR_NEG  0x09
#define EXPR_SIGN 0x0A
#define EXPR_ADD  0x0B
#define EXPR_SUB  0x0C
#define EXPR_MULT 0x0D
#define EXPR_DIV  0x0E
#define EXPR_REM  0x0F
#define EXPR_COMP 0x10
#define EXPR_SHFL 0x11
#define EXPR_SHFR 0x12
#define EXPR_EQ   0x13
#define EXPR_LESS 0x14
#define EXPR_IF   0x15
#define EXPR_TSTB 0x16
#define EXPR_SETB 0x17
#define EXPR_CLRB 0x18
#define EXPR_ELEM 0x19
#define EXPR_LEN  0x1A
#define EXPR_CONS 0x1B
#define EXPR_APND 0x1C
#define EXPR_PACK 0x1D
