...
prop_div :: ArduinoConnection -> RemoteRef Word32 -> Word32 -> Word32 -> Property
...
prop_rem :: ArduinoConnection -> RemoteRef Word32 -> Word32 -> Word32 -> Property
...
prop_arith :: ArduinoConnection -> RemoteRef Word32 -> 
              Word32 -> Word32 -> Word32 -> Word32 -> Word32 -> Word32 -> Property
...
main = do
    ...
    quickCheck (prop_to8 conn ref)
    print "To Word16 Tests:"
    quickCheck (prop_to16 conn ref)
    print "ifB Tests:"
