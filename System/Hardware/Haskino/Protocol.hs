...
packageCodeBlock (Arduino commands) ix ib = (cmds', ix', ib')
  where
      ...
      packProcedure MicrosE ix ib cmds = (remBind ib, B.append cmds (lenPackage (packageProcedure MicrosE ib)), ix, ib)
      ...
      packProcedure (DelayMillisE ms) ix ib cmds = ((), B.append cmds (lenPackage (packageProcedure (DelayMillisE ms) ib)), ix, ib+1)
      packProcedure (DelayMicros ms) ix ib cmds = ((), B.append cmds (lenPackage (packageProcedure (DelayMicros ms) ib)), ix, ib)
      packProcedure (DelayMicrosE ms) ix ib cmds = ((), B.append cmds (lenPackage (packageProcedure (DelayMicrosE ms) ib)), ix, ib+1)  
      ...
      packProcedure (BootTaskE tid) ix ib cmds = (remBind ib, B.append cmds (lenPackage (packageProcedure (BootTaskE tid) ib)), ix, ib+1) 
      ...
      packProcedure (NewRemoteRefB e) ix ib cmds = (remBind ib, B.append cmds (lenPackage (packageRemoteBinding (NewRemoteRefB e) ix ib)), ix+1, ib+1)
{-
      packProcedure (NewRemoteRefW8 e) ix ib cmds = (remBind ib, B.append cmds (lenPackage (packageRemoteBinding (NewRemoteRefW8 e) ix ib)), ix+1, ib+1)
      packProcedure (NewRemoteRefW16 e) ix ib cmds = (remBind ib, B.append cmds (lenPackage (packageRemoteBinding (NewRemoteRefW16 e) ix ib)), ix+1, ib+1)
      packProcedure (NewRemoteRefW32 e) ix ib cmds = (remBind ib, B.append cmds (lenPackage (packageRemoteBinding (NewRemoteRefW32 e) ix ib)), ix+1, ib+1)
      packProcedure (NewRemoteRefI8 e) ix ib cmds = (remBind ib, B.append cmds (lenPackage (packageRemoteBinding (NewRemoteRefI8 e) ix ib)), ix+1, ib+1)
      packProcedure (NewRemoteRefI16 e) ix ib cmds = (remBind ib, B.append cmds (lenPackage (packageRemoteBinding (NewRemoteRefI16 e) ix ib)), ix+1, ib+1)
      packProcedure (NewRemoteRefI32 e) ix ib cmds = (remBind ib, B.append cmds (lenPackage (packageRemoteBinding (NewRemoteRefI32 e) ix ib)), ix+1, ib+1)
      packProcedure (NewRemoteRefL8 e) ix ib cmds = (remBind ib, B.append cmds (lenPackage (packageRemoteBinding (NewRemoteRefL8 e) ix ib)), ix+1, ib+1)
      packProcedure (NewRemoteRefFloat e) ix ib cmds = (remBind ib, B.append cmds (lenPackage (packageRemoteBinding (NewRemoteRefFloat e) ix ib)), ix+1, ib+1)
-}
