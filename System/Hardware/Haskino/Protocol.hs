...
packageCodeBlock (Arduino commands) ix ib = (cmds', ix', ib')
  where
      ...
      packProcedure QueryFirmware ix ib cmds = (0, packageProcedure QueryFirmware ib, ix, ib)
      packProcedure QueryFirmwareE ix ib cmds = (remBind ib, packageProcedure QueryFirmwareE ib, ix, ib+1)
      packProcedure QueryProcessor ix ib cmds = (UNKNOWN_PROCESSOR, packageProcedure QueryProcessor ib, ix, ib)
      packProcedure QueryProcessorE ix ib cmds = (remBind ib, packageProcedure QueryProcessorE ib, ix, ib+1)
      packProcedure Micros ix ib cmds = (0, packageProcedure Micros ib, ix, ib)
      packProcedure MicrosE ix ib cmds = (remBind ib, packageProcedure MicrosE ib, ix, ib)
      packProcedure Millis ix ib cmds = (0, packageProcedure Millis ib, ix, ib)
      packProcedure MillisE ix ib cmds = (remBind ib, packageProcedure MillisE ib, ix, ib+1)
      packProcedure (DelayMillis ms) ix ib cmds = ((), packageProcedure (DelayMillis ms) ib, ix, ib)
      packProcedure (DelayMillisE ms) ix ib cmds = ((), packageProcedure (DelayMillisE ms) ib, ix, ib+1)
      packProcedure (DelayMicros ms) ix ib cmds = ((), packageProcedure (DelayMicros ms) ib, ix, ib)
      packProcedure (DelayMicrosE ms) ix ib cmds = ((), packageProcedure (DelayMicrosE ms) ib, ix, ib+1)  
      packProcedure (DigitalRead p) ix ib cmds = (False, packageProcedure (DigitalRead p) ib, ix, ib)
      packProcedure (DigitalReadE p) ib ix cmds = (remBind ib, packageProcedure (DigitalReadE p) ib, ix, ib+1)
      packProcedure (DigitalPortRead p m) ix ib cmds = (0, packageProcedure (DigitalPortRead p m) ib, ix, ib)
      packProcedure (DigitalPortReadE p m) ib ix cmds = (remBind ib, packageProcedure (DigitalPortReadE p m) ib, ix, ib+1)
      packProcedure (AnalogRead p) ix ib cmds = (0, packageProcedure (AnalogRead p) ib, ix, ib)
      packProcedure (AnalogReadE p) ix ib cmds = (remBind ib, packageProcedure (AnalogReadE p) ib, ix, ib+1)
      packProcedure (I2CRead p n) ix ib cmds = ([], packageProcedure (I2CRead p n) ib, ix, ib)
      packProcedure (I2CReadE p n) ix ib cmds = (remBind ib, packageProcedure (I2CReadE p n) ib, ix, ib+1)
      packProcedure (Stepper2Pin s p1 p2) ix ib cmds = (0, packageProcedure (Stepper2Pin s p1 p2) ib, ix, ib)
      packProcedure (Stepper2PinE s p1 p2) ix ib cmds = (remBind ib, packageProcedure (Stepper2PinE s p1 p2) ib, ix, ib+1)
      packProcedure (Stepper4Pin s p1 p2 p3 p4) ix ib cmds = (0, packageProcedure (Stepper4Pin s p1 p2 p3 p4) ib, ix, ib)
      packProcedure (Stepper4PinE s p1 p2 p3 p4) ix ib cmds = (remBind ib, packageProcedure (Stepper4PinE s p1 p2 p3 p4) ib, ix, ib+1)
      packProcedure (StepperStepE st s) ix ib cmds = ((), packageProcedure (StepperStepE st s) ib, ix, ib+1)
      packProcedure (ServoAttach p) ix ib cmds = (0, packageProcedure (ServoAttach p) ib, ix, ib)
      packProcedure (ServoAttachE p) ix ib cmds = (remBind ib, packageProcedure (ServoAttachE p) ib, ix, ib+1)
      packProcedure (ServoAttachMinMax p min max) ix ib cmds = (0, packageProcedure (ServoAttachMinMax p min max) ib, ix, ib)
      packProcedure (ServoAttachMinMaxE p min max) ix ib cmds = (remBind ib, packageProcedure (ServoAttachMinMaxE p min max) ib, ix, ib+1)
      packProcedure (ServoRead sv) ix ib cmds = (0, packageProcedure (ServoRead sv) ib, ix, ib)
      packProcedure (ServoReadE sv) ix ib cmds = (remBind ib, packageProcedure (ServoReadE sv) ib, ix, ib+1)
      packProcedure (ServoReadMicros sv) ix ib cmds = (0, packageProcedure (ServoReadMicros sv) ib, ix, ib)
      packProcedure (ServoReadMicrosE sv) ix ib cmds = (remBind ib, packageProcedure (ServoReadMicrosE sv) ib, ix, ib+1)
      packProcedure QueryAllTasks ix ib cmds = ([], packageProcedure QueryAllTasks ib, ix, ib)
      packProcedure QueryAllTasksE ix ib cmds = (remBind ib, packageProcedure QueryAllTasksE ib, ix, ib+1)
      packProcedure (QueryTask t) ix ib cmds = (Nothing, packageProcedure (QueryTask t) ib, ix, ib)
      packProcedure (QueryTaskE t) ix ib cmds = (Nothing, packageProcedure (QueryTaskE t) ib, ix, ib+1)
      packProcedure (BootTaskE tid) ix ib cmds = (remBind ib, packageProcedure (BootTaskE tid) ib, ix, ib+1) 
      packProcedure (ReadRemoteRefB (RemoteRefB i)) ix ib cmds = (remBind ib, packageProcedure (ReadRemoteRefB (RemoteRefB i)) ib, ix, ib+1)
      packProcedure (ReadRemoteRefW8 (RemoteRefW8 i)) ix ib cmds = (remBind ib, packageProcedure (ReadRemoteRefW8 (RemoteRefW8 i)) ib, ix, ib+1)
      packProcedure (ReadRemoteRefW16 (RemoteRefW16 i)) ix ib cmds = (remBind ib, packageProcedure (ReadRemoteRefW16 (RemoteRefW16 i)) ib, ix, ib+1)
      packProcedure (ReadRemoteRefW32 (RemoteRefW32 i)) ix ib cmds = (remBind ib, packageProcedure (ReadRemoteRefW32 (RemoteRefW32 i)) ib, ix, ib+1)
      packProcedure (ReadRemoteRefI8 (RemoteRefI8 i)) ix ib cmds = (remBind ib, packageProcedure (ReadRemoteRefI8 (RemoteRefI8 i)) ib, ix, ib+1)
      packProcedure (ReadRemoteRefI16 (RemoteRefI16 i)) ix ib cmds = (remBind ib, packageProcedure (ReadRemoteRefI16 (RemoteRefI16 i)) ib, ix, ib+1)
      packProcedure (ReadRemoteRefI32 (RemoteRefI32 i)) ix ib cmds = (remBind ib, packageProcedure (ReadRemoteRefI32 (RemoteRefI32 i)) ib, ix, ib+1)
      packProcedure (ReadRemoteRefL8 (RemoteRefL8 i)) ix ib cmds = (remBind ib, packageProcedure (ReadRemoteRefL8 (RemoteRefL8 i)) ib, ix, ib+1)
      packProcedure (ReadRemoteRefFloat (RemoteRefFloat i)) ix ib cmds = (remBind ib, packageProcedure (ReadRemoteRefFloat (RemoteRefFloat i)) ib, ix, ib+1)
      packProcedure (NewRemoteRefB e) ix ib cmds = (RemoteRefB ix, packageRemoteBinding (NewRemoteRefB e) ix ib, ix+1, ib+1)
      packProcedure (NewRemoteRefW8 e) ix ib cmds = (RemoteRefW8 ix, packageRemoteBinding (NewRemoteRefW8 e) ix ib, ix+1, ib+1)
      packProcedure (NewRemoteRefW16 e) ix ib cmds = (RemoteRefW16 ix, packageRemoteBinding (NewRemoteRefW16 e) ix ib, ix+1, ib+1)
      packProcedure (NewRemoteRefW32 e) ix ib cmds = (RemoteRefW32 ix, packageRemoteBinding (NewRemoteRefW32 e) ix ib, ix+1, ib+1)
      packProcedure (NewRemoteRefI8 e) ix ib cmds = (RemoteRefI8 ix, packageRemoteBinding (NewRemoteRefI8 e) ix ib, ix+1, ib+1)
      packProcedure (NewRemoteRefI16 e) ix ib cmds = (RemoteRefI16 ix, packageRemoteBinding (NewRemoteRefI16 e) ix ib, ix+1, ib+1)
      packProcedure (NewRemoteRefI32 e) ix ib cmds = (RemoteRefI32 ix, packageRemoteBinding (NewRemoteRefI32 e) ix ib, ix+1, ib+1)
      packProcedure (NewRemoteRefL8 e) ix ib cmds = (RemoteRefL8 ix, packageRemoteBinding (NewRemoteRefL8 e) ix ib, ix+1, ib+1)
      packProcedure (NewRemoteRefFloat e) ix ib cmds = (RemoteRefFloat ix, packageRemoteBinding (NewRemoteRefFloat e) ix ib, ix+1, ib+1)
      ...
      packAppl (T.Procedure p) ix ib cmds = (r, B.append cmds (lenPackage pc), ix', ib')
        where 
          (r, pc, ix', ib') = packProcedure p ix ib cmds
