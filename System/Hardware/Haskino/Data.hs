...
data ArduinoPrimitive :: * -> * where
     ...
     IterateUnitUnitE     :: Expr Int -> Expr () -> (Expr Int -> Expr () -> Arduino (ExprEither () ())) -> ArduinoPrimitive (Expr ())
     IterateUnitBoolE     :: Expr Int -> Expr () -> (Expr Int -> Expr () -> Arduino (ExprEither () Bool)) -> ArduinoPrimitive (Expr Bool)
     IterateUnitW8E       :: Expr Int -> Expr () -> (Expr Int -> Expr () -> Arduino (ExprEither () Word8)) -> ArduinoPrimitive (Expr Word8)
     IterateUnitW16E      :: Expr Int -> Expr () -> (Expr Int -> Expr () -> Arduino (ExprEither () Word16)) -> ArduinoPrimitive (Expr Word16)
     IterateUnitW32E      :: Expr Int -> Expr () -> (Expr Int -> Expr () -> Arduino (ExprEither () Word32)) -> ArduinoPrimitive (Expr Word32)
     IterateUnitI8E       :: Expr Int -> Expr () -> (Expr Int -> Expr () -> Arduino (ExprEither () Int8)) -> ArduinoPrimitive (Expr Int8)
     IterateUnitI16E      :: Expr Int -> Expr () -> (Expr Int -> Expr () -> Arduino (ExprEither () Int16)) -> ArduinoPrimitive (Expr Int16)
     IterateUnitI32E      :: Expr Int -> Expr () -> (Expr Int -> Expr () -> Arduino (ExprEither () Int32)) -> ArduinoPrimitive (Expr Int32)
     IterateUnitIE        :: Expr Int -> Expr () -> (Expr Int -> Expr () -> Arduino (ExprEither () Int)) -> ArduinoPrimitive (Expr Int)
     IterateUnitL8E       :: Expr Int -> Expr () -> (Expr Int -> Expr () -> Arduino (ExprEither () [Word8])) -> ArduinoPrimitive (Expr [Word8])
     IterateUnitFloatE    :: Expr Int -> Expr () -> (Expr Int -> Expr () -> Arduino (ExprEither () Float)) -> ArduinoPrimitive (Expr Float)
     IterateBoolUnitE     :: Expr Int -> Expr Bool -> (Expr Int -> Expr Bool -> Arduino (ExprEither Bool ())) -> ArduinoPrimitive (Expr ())
     IterateBoolBoolE     :: Expr Int -> Expr Bool -> (Expr Int -> Expr Bool -> Arduino (ExprEither Bool Bool)) -> ArduinoPrimitive (Expr Bool)
     IterateBoolW8E       :: Expr Int -> Expr Bool -> (Expr Int -> Expr Bool -> Arduino (ExprEither Bool Word8)) -> ArduinoPrimitive (Expr Word8)
     IterateBoolW16E      :: Expr Int -> Expr Bool -> (Expr Int -> Expr Bool -> Arduino (ExprEither Bool Word16)) -> ArduinoPrimitive (Expr Word16)
     IterateBoolW32E      :: Expr Int -> Expr Bool -> (Expr Int -> Expr Bool -> Arduino (ExprEither Bool Word32)) -> ArduinoPrimitive (Expr Word32)
     IterateBoolI8E       :: Expr Int -> Expr Bool -> (Expr Int -> Expr Bool -> Arduino (ExprEither Bool Int8)) -> ArduinoPrimitive (Expr Int8)
     IterateBoolI16E      :: Expr Int -> Expr Bool -> (Expr Int -> Expr Bool -> Arduino (ExprEither Bool Int16)) -> ArduinoPrimitive (Expr Int16)
     IterateBoolI32E      :: Expr Int -> Expr Bool -> (Expr Int -> Expr Bool -> Arduino (ExprEither Bool Int32)) -> ArduinoPrimitive (Expr Int32)
     IterateBoolIE        :: Expr Int -> Expr Bool -> (Expr Int -> Expr Bool -> Arduino (ExprEither Bool Int)) -> ArduinoPrimitive (Expr Int)
     IterateBoolL8E       :: Expr Int -> Expr Bool -> (Expr Int -> Expr Bool -> Arduino (ExprEither Bool [Word8])) -> ArduinoPrimitive (Expr [Word8])
     IterateBoolFloatE    :: Expr Int -> Expr Bool -> (Expr Int -> Expr Bool -> Arduino (ExprEither Bool Float)) -> ArduinoPrimitive (Expr Float)
     IterateW8UnitE       :: Expr Int -> Expr Word8 -> (Expr Int -> Expr Word8 -> Arduino (ExprEither Word8 ())) -> ArduinoPrimitive (Expr ())
     IterateW8BoolE       :: Expr Int -> Expr Word8 -> (Expr Int -> Expr Word8 -> Arduino (ExprEither Word8 Bool)) -> ArduinoPrimitive (Expr Bool)
     IterateW8W8E         :: Expr Int -> Expr Word8 -> (Expr Int -> Expr Word8 -> Arduino (ExprEither Word8 Word8)) -> ArduinoPrimitive (Expr Word8)
     IterateW8W16E        :: Expr Int -> Expr Word8 -> (Expr Int -> Expr Word8 -> Arduino (ExprEither Word8 Word16)) -> ArduinoPrimitive (Expr Word16)
     IterateW8W32E        :: Expr Int -> Expr Word8 -> (Expr Int -> Expr Word8 -> Arduino (ExprEither Word8 Word32)) -> ArduinoPrimitive (Expr Word32)
     IterateW8I8E         :: Expr Int -> Expr Word8 -> (Expr Int -> Expr Word8 -> Arduino (ExprEither Word8 Int8)) -> ArduinoPrimitive (Expr Int8)
     IterateW8I16E        :: Expr Int -> Expr Word8 -> (Expr Int -> Expr Word8 -> Arduino (ExprEither Word8 Int16)) -> ArduinoPrimitive (Expr Int16)
     IterateW8I32E        :: Expr Int -> Expr Word8 -> (Expr Int -> Expr Word8 -> Arduino (ExprEither Word8 Int32)) -> ArduinoPrimitive (Expr Int32)
     IterateW8IE          :: Expr Int -> Expr Word8 -> (Expr Int -> Expr Word8 -> Arduino (ExprEither Word8 Int)) -> ArduinoPrimitive (Expr Int)
     IterateW8L8E         :: Expr Int -> Expr Word8 -> (Expr Int -> Expr Word8 -> Arduino (ExprEither Word8 [Word8])) -> ArduinoPrimitive (Expr [Word8])
     IterateW8FloatE      :: Expr Int -> Expr Word8 -> (Expr Int -> Expr Word8 -> Arduino (ExprEither Word8 Float)) -> ArduinoPrimitive (Expr Float)
     IterateW16UnitE      :: Expr Int -> Expr Word16 -> (Expr Int -> Expr Word16 -> Arduino (ExprEither Word16 ())) -> ArduinoPrimitive (Expr ())
     IterateW16BoolE      :: Expr Int -> Expr Word16 -> (Expr Int -> Expr Word16 -> Arduino (ExprEither Word16 Bool)) -> ArduinoPrimitive (Expr Bool)
     IterateW16W8E        :: Expr Int -> Expr Word16 -> (Expr Int -> Expr Word16 -> Arduino (ExprEither Word16 Word8)) -> ArduinoPrimitive (Expr Word8)
     IterateW16W16E       :: Expr Int -> Expr Word16 -> (Expr Int -> Expr Word16 -> Arduino (ExprEither Word16 Word16)) -> ArduinoPrimitive (Expr Word16)
     IterateW16W32E       :: Expr Int -> Expr Word16 -> (Expr Int -> Expr Word16 -> Arduino (ExprEither Word16 Word32)) -> ArduinoPrimitive (Expr Word32)
     IterateW16I8E        :: Expr Int -> Expr Word16 -> (Expr Int -> Expr Word16 -> Arduino (ExprEither Word16 Int8)) -> ArduinoPrimitive (Expr Int8)
     IterateW16I16E       :: Expr Int -> Expr Word16 -> (Expr Int -> Expr Word16 -> Arduino (ExprEither Word16 Int16)) -> ArduinoPrimitive (Expr Int16)
     IterateW16I32E       :: Expr Int -> Expr Word16 -> (Expr Int -> Expr Word16 -> Arduino (ExprEither Word16 Int32)) -> ArduinoPrimitive (Expr Int32)
     IterateW16IE         :: Expr Int -> Expr Word16 -> (Expr Int -> Expr Word16 -> Arduino (ExprEither Word16 Int)) -> ArduinoPrimitive (Expr Int)
     IterateW16L8E        :: Expr Int -> Expr Word16 -> (Expr Int -> Expr Word16 -> Arduino (ExprEither Word16 [Word8])) -> ArduinoPrimitive (Expr [Word8])
     IterateW16FloatE     :: Expr Int -> Expr Word16 -> (Expr Int -> Expr Word16 -> Arduino (ExprEither Word16 Float)) -> ArduinoPrimitive (Expr Float)
     IterateW32UnitE      :: Expr Int -> Expr Word32 -> (Expr Int -> Expr Word32 -> Arduino (ExprEither Word32 ())) -> ArduinoPrimitive (Expr ())
     IterateW32BoolE      :: Expr Int -> Expr Word32 -> (Expr Int -> Expr Word32 -> Arduino (ExprEither Word32 Bool)) -> ArduinoPrimitive (Expr Bool)
     IterateW32W8E        :: Expr Int -> Expr Word32 -> (Expr Int -> Expr Word32 -> Arduino (ExprEither Word32 Word8)) -> ArduinoPrimitive (Expr Word8)
     IterateW32W16E       :: Expr Int -> Expr Word32 -> (Expr Int -> Expr Word32 -> Arduino (ExprEither Word32 Word16)) -> ArduinoPrimitive (Expr Word16)
     IterateW32W32E       :: Expr Int -> Expr Word32 -> (Expr Int -> Expr Word32 -> Arduino (ExprEither Word32 Word32)) -> ArduinoPrimitive (Expr Word32)
     IterateW32I8E        :: Expr Int -> Expr Word32 -> (Expr Int -> Expr Word32 -> Arduino (ExprEither Word32 Int8)) -> ArduinoPrimitive (Expr Int8)
     IterateW32I16E       :: Expr Int -> Expr Word32 -> (Expr Int -> Expr Word32 -> Arduino (ExprEither Word32 Int16)) -> ArduinoPrimitive (Expr Int16)
     IterateW32I32E       :: Expr Int -> Expr Word32 -> (Expr Int -> Expr Word32 -> Arduino (ExprEither Word32 Int32)) -> ArduinoPrimitive (Expr Int32)
     IterateW32IE         :: Expr Int -> Expr Word32 -> (Expr Int -> Expr Word32 -> Arduino (ExprEither Word32 Int)) -> ArduinoPrimitive (Expr Int)
     IterateW32L8E        :: Expr Int -> Expr Word32 -> (Expr Int -> Expr Word32 -> Arduino (ExprEither Word32 [Word8])) -> ArduinoPrimitive (Expr [Word8])
     IterateW32FloatE     :: Expr Int -> Expr Word32 -> (Expr Int -> Expr Word32 -> Arduino (ExprEither Word32 Float)) -> ArduinoPrimitive (Expr Float)
     IterateI8UnitE       :: Expr Int -> Expr Int8 -> (Expr Int -> Expr Int8 -> Arduino (ExprEither Int8 ())) -> ArduinoPrimitive (Expr ())
     IterateI8BoolE       :: Expr Int -> Expr Int8 -> (Expr Int -> Expr Int8 -> Arduino (ExprEither Int8 Bool)) -> ArduinoPrimitive (Expr Bool)
     IterateI8W8E         :: Expr Int -> Expr Int8 -> (Expr Int -> Expr Int8 -> Arduino (ExprEither Int8 Word8)) -> ArduinoPrimitive (Expr Word8)
     IterateI8W16E        :: Expr Int -> Expr Int8 -> (Expr Int -> Expr Int8 -> Arduino (ExprEither Int8 Word16)) -> ArduinoPrimitive (Expr Word16)
     IterateI8W32E        :: Expr Int -> Expr Int8 -> (Expr Int -> Expr Int8 -> Arduino (ExprEither Int8 Word32)) -> ArduinoPrimitive (Expr Word32)
     IterateI8I8E         :: Expr Int -> Expr Int8 -> (Expr Int -> Expr Int8 -> Arduino (ExprEither Int8 Int8)) -> ArduinoPrimitive (Expr Int8)
     IterateI8I16E        :: Expr Int -> Expr Int8 -> (Expr Int -> Expr Int8 -> Arduino (ExprEither Int8 Int16)) -> ArduinoPrimitive (Expr Int16)
     IterateI8I32E        :: Expr Int -> Expr Int8 -> (Expr Int -> Expr Int8 -> Arduino (ExprEither Int8 Int32)) -> ArduinoPrimitive (Expr Int32)
     IterateI8IE          :: Expr Int -> Expr Int8 -> (Expr Int -> Expr Int8 -> Arduino (ExprEither Int8 Int)) -> ArduinoPrimitive (Expr Int)
     IterateI8L8E         :: Expr Int -> Expr Int8 -> (Expr Int -> Expr Int8 -> Arduino (ExprEither Int8 [Word8])) -> ArduinoPrimitive (Expr [Word8])
     IterateI8FloatE      :: Expr Int -> Expr Int8 -> (Expr Int -> Expr Int8 -> Arduino (ExprEither Int8 Float)) -> ArduinoPrimitive (Expr Float)
     IterateI16UnitE      :: Expr Int -> Expr Int16 -> (Expr Int -> Expr Int16 -> Arduino (ExprEither Int16 ())) -> ArduinoPrimitive (Expr ())
     IterateI16BoolE      :: Expr Int -> Expr Int16 -> (Expr Int -> Expr Int16 -> Arduino (ExprEither Int16 Bool)) -> ArduinoPrimitive (Expr Bool)
     IterateI16W8E        :: Expr Int -> Expr Int16 -> (Expr Int -> Expr Int16 -> Arduino (ExprEither Int16 Word8)) -> ArduinoPrimitive (Expr Word8)
     IterateI16W16E       :: Expr Int -> Expr Int16 -> (Expr Int -> Expr Int16 -> Arduino (ExprEither Int16 Word16)) -> ArduinoPrimitive (Expr Word16)
     IterateI16W32E       :: Expr Int -> Expr Int16 -> (Expr Int -> Expr Int16 -> Arduino (ExprEither Int16 Word32)) -> ArduinoPrimitive (Expr Word32)
     IterateI16I8E        :: Expr Int -> Expr Int16 -> (Expr Int -> Expr Int16 -> Arduino (ExprEither Int16 Int8)) -> ArduinoPrimitive (Expr Int8)
     IterateI16I16E       :: Expr Int -> Expr Int16 -> (Expr Int -> Expr Int16 -> Arduino (ExprEither Int16 Int16)) -> ArduinoPrimitive (Expr Int16)
     IterateI16I32E       :: Expr Int -> Expr Int16 -> (Expr Int -> Expr Int16 -> Arduino (ExprEither Int16 Int32)) -> ArduinoPrimitive (Expr Int32)
     IterateI16IE         :: Expr Int -> Expr Int16 -> (Expr Int -> Expr Int16 -> Arduino (ExprEither Int16 Int)) -> ArduinoPrimitive (Expr Int)
     IterateI16L8E        :: Expr Int -> Expr Int16 -> (Expr Int -> Expr Int16 -> Arduino (ExprEither Int16 [Word8])) -> ArduinoPrimitive (Expr [Word8])
     IterateI16FloatE     :: Expr Int -> Expr Int16 -> (Expr Int -> Expr Int16 -> Arduino (ExprEither Int16 Float)) -> ArduinoPrimitive (Expr Float)
     IterateI32UnitE      :: Expr Int -> Expr Int32 -> (Expr Int -> Expr Int32 -> Arduino (ExprEither Int32 ())) -> ArduinoPrimitive (Expr ())
     IterateI32BoolE      :: Expr Int -> Expr Int32 -> (Expr Int -> Expr Int32 -> Arduino (ExprEither Int32 Bool)) -> ArduinoPrimitive (Expr Bool)
     IterateI32W8E        :: Expr Int -> Expr Int32 -> (Expr Int -> Expr Int32 -> Arduino (ExprEither Int32 Word8)) -> ArduinoPrimitive (Expr Word8)
     IterateI32W16E       :: Expr Int -> Expr Int32 -> (Expr Int -> Expr Int32 -> Arduino (ExprEither Int32 Word16)) -> ArduinoPrimitive (Expr Word16)
     IterateI32W32E       :: Expr Int -> Expr Int32 -> (Expr Int -> Expr Int32 -> Arduino (ExprEither Int32 Word32)) -> ArduinoPrimitive (Expr Word32)
     IterateI32I8E        :: Expr Int -> Expr Int32 -> (Expr Int -> Expr Int32 -> Arduino (ExprEither Int32 Int8)) -> ArduinoPrimitive (Expr Int8)
     IterateI32I16E       :: Expr Int -> Expr Int32 -> (Expr Int -> Expr Int32 -> Arduino (ExprEither Int32 Int16)) -> ArduinoPrimitive (Expr Int16)
     IterateI32I32E       :: Expr Int -> Expr Int32 -> (Expr Int -> Expr Int32 -> Arduino (ExprEither Int32 Int32)) -> ArduinoPrimitive (Expr Int32)
     IterateI32IE         :: Expr Int -> Expr Int32 -> (Expr Int -> Expr Int32 -> Arduino (ExprEither Int32 Int)) -> ArduinoPrimitive (Expr Int)
     IterateI32L8E        :: Expr Int -> Expr Int32 -> (Expr Int -> Expr Int32 -> Arduino (ExprEither Int32 [Word8])) -> ArduinoPrimitive (Expr [Word8])
     IterateI32FloatE     :: Expr Int -> Expr Int32 -> (Expr Int -> Expr Int32 -> Arduino (ExprEither Int32 Float)) -> ArduinoPrimitive (Expr Float)
     IterateIUnitE        :: Expr Int -> Expr Int -> (Expr Int -> Expr Int -> Arduino (ExprEither Int ())) -> ArduinoPrimitive (Expr ())
     IterateIBoolE        :: Expr Int -> Expr Int -> (Expr Int -> Expr Int -> Arduino (ExprEither Int Bool)) -> ArduinoPrimitive (Expr Bool)
     IterateIW8E          :: Expr Int -> Expr Int -> (Expr Int -> Expr Int -> Arduino (ExprEither Int Word8)) -> ArduinoPrimitive (Expr Word8)
     IterateIW16E         :: Expr Int -> Expr Int -> (Expr Int -> Expr Int -> Arduino (ExprEither Int Word16)) -> ArduinoPrimitive (Expr Word16)
     IterateIW32E         :: Expr Int -> Expr Int -> (Expr Int -> Expr Int -> Arduino (ExprEither Int Word32)) -> ArduinoPrimitive (Expr Word32)
     IterateII8E          :: Expr Int -> Expr Int -> (Expr Int -> Expr Int -> Arduino (ExprEither Int Int8)) -> ArduinoPrimitive (Expr Int8)
     IterateII16E         :: Expr Int -> Expr Int -> (Expr Int -> Expr Int -> Arduino (ExprEither Int Int16)) -> ArduinoPrimitive (Expr Int16)
     IterateII32E         :: Expr Int -> Expr Int -> (Expr Int -> Expr Int -> Arduino (ExprEither Int Int32)) -> ArduinoPrimitive (Expr Int32)
     IterateIIE           :: Expr Int -> Expr Int -> (Expr Int -> Expr Int -> Arduino (ExprEither Int Int)) -> ArduinoPrimitive (Expr Int)
     IterateIL8E          :: Expr Int -> Expr Int -> (Expr Int -> Expr Int -> Arduino (ExprEither Int [Word8])) -> ArduinoPrimitive (Expr [Word8])
     IterateIFloatE       :: Expr Int -> Expr Int -> (Expr Int -> Expr Int -> Arduino (ExprEither Int Float)) -> ArduinoPrimitive (Expr Float)
     IterateL8UnitE       :: Expr Int -> Expr [Word8] -> (Expr Int -> Expr [Word8] -> Arduino (ExprEither [Word8] ())) -> ArduinoPrimitive (Expr ())
     IterateL8BoolE       :: Expr Int -> Expr [Word8] -> (Expr Int -> Expr [Word8] -> Arduino (ExprEither [Word8] Bool)) -> ArduinoPrimitive (Expr Bool)
     IterateL8W8E         :: Expr Int -> Expr [Word8] -> (Expr Int -> Expr [Word8] -> Arduino (ExprEither [Word8] Word8)) -> ArduinoPrimitive (Expr Word8)
     IterateL8W16E        :: Expr Int -> Expr [Word8] -> (Expr Int -> Expr [Word8] -> Arduino (ExprEither [Word8] Word16)) -> ArduinoPrimitive (Expr Word16)
     IterateL8W32E        :: Expr Int -> Expr [Word8] -> (Expr Int -> Expr [Word8] -> Arduino (ExprEither [Word8] Word32)) -> ArduinoPrimitive (Expr Word32)
     IterateL8I8E         :: Expr Int -> Expr [Word8] -> (Expr Int -> Expr [Word8] -> Arduino (ExprEither [Word8] Int8)) -> ArduinoPrimitive (Expr Int8)
     IterateL8I16E        :: Expr Int -> Expr [Word8] -> (Expr Int -> Expr [Word8] -> Arduino (ExprEither [Word8] Int16)) -> ArduinoPrimitive (Expr Int16)
     IterateL8I32E        :: Expr Int -> Expr [Word8] -> (Expr Int -> Expr [Word8] -> Arduino (ExprEither [Word8] Int32)) -> ArduinoPrimitive (Expr Int32)
     IterateL8IE          :: Expr Int -> Expr [Word8] -> (Expr Int -> Expr [Word8] -> Arduino (ExprEither [Word8] Int)) -> ArduinoPrimitive (Expr Int)
     IterateL8L8E         :: Expr Int -> Expr [Word8] -> (Expr Int -> Expr [Word8] -> Arduino (ExprEither [Word8] [Word8])) -> ArduinoPrimitive (Expr [Word8])
     IterateL8FloatE      :: Expr Int -> Expr [Word8] -> (Expr Int -> Expr [Word8] -> Arduino (ExprEither [Word8] Float)) -> ArduinoPrimitive (Expr Float)
     IterateFloatUnitE    :: Expr Int -> Expr Float -> (Expr Int -> Expr Float -> Arduino (ExprEither Float ())) -> ArduinoPrimitive (Expr ())
     IterateFloatBoolE    :: Expr Int -> Expr Float -> (Expr Int -> Expr Float -> Arduino (ExprEither Float Bool)) -> ArduinoPrimitive (Expr Bool)
     IterateFloatW8E      :: Expr Int -> Expr Float -> (Expr Int -> Expr Float -> Arduino (ExprEither Float Word8)) -> ArduinoPrimitive (Expr Word8)
     IterateFloatW16E     :: Expr Int -> Expr Float -> (Expr Int -> Expr Float -> Arduino (ExprEither Float Word16)) -> ArduinoPrimitive (Expr Word16)
     IterateFloatW32E     :: Expr Int -> Expr Float -> (Expr Int -> Expr Float -> Arduino (ExprEither Float Word32)) -> ArduinoPrimitive (Expr Word32)
     IterateFloatI8E      :: Expr Int -> Expr Float -> (Expr Int -> Expr Float -> Arduino (ExprEither Float Int8)) -> ArduinoPrimitive (Expr Int8)
     IterateFloatI16E     :: Expr Int -> Expr Float -> (Expr Int -> Expr Float -> Arduino (ExprEither Float Int16)) -> ArduinoPrimitive (Expr Int16)
     IterateFloatI32E     :: Expr Int -> Expr Float -> (Expr Int -> Expr Float -> Arduino (ExprEither Float Int32)) -> ArduinoPrimitive (Expr Int32)
...
class (ExprB a, ExprB b) => ArduinoIterate a b where
    iterateE  :: Expr Int -> Expr a -> (Expr Int -> Expr a -> Arduino (ExprEither a b)) -> Arduino (Expr b)
...
whileE :: ArduinoIterate a a => Expr a -> (Expr a -> Expr Bool) ->
                     (Expr Int -> Expr a -> Arduino (Expr a)) -> Arduino (Expr a)
whileE i tf bf = iterateE litZero i ibf
  where
    ibf _ i' = do
        ifThenElseEither (tf i') (do
                                    res <- bf litZero i'
                                    return $ ExprLeft litZero res) (return $ ExprRight i')

repeatUntilE :: ArduinoIterate a a => Expr a -> (Expr a -> Expr Bool) ->
                     (Expr Int -> Expr a -> Arduino (Expr a)) -> Arduino (Expr a)
repeatUntilE i tf bf = iterateE litZero i ibf
  where
    ibf _ i' = do
        res <- bf litZero i'
        ifThenElseEither (tf i') (return $ ExprLeft litZero res) (return $ ExprRight i')

loopE :: Arduino (Expr ()) -> Arduino (Expr ())
loopE bf = iterateE litZero LitUnit (\_ _ -> bf >> (return $ ExprLeft litZero LitUnit))

forInE :: Expr [Word8] -> (Expr Int -> Expr Word8 -> Arduino (Expr ())) -> Arduino (Expr ())
forInE ws bf = iterateE litZero 0 ibf
  where
    ibf _ i = do
        _ <- bf litZero (ws !!* i)
        ifThenElseEither (i `lessE` (len ws)) (return $ ExprLeft litZero (i+1)) (return $ ExprRight LitUnit)
