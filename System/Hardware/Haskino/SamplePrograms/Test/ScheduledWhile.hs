-------------------------------------------------------------------------------
-- |
-- Module      :  System.Hardware.Haskino.SamplePrograms.TEst.ScheduledWhile
...
module System.Hardware.Haskino.SamplePrograms.Test.ScheduledWhile where
...
scheduledWhile :: IO ()
scheduledWhile = withArduino True "/dev/cu.usbmodem1421" $ do
    let led = 13
    let tid = 1
