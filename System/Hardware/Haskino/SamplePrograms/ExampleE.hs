-------------------------------------------------------------------------------
-- |
-- Module      :  System.Hardware.Haskino.SamplePrograms.ButtonE
...
module System.Hardware.Haskino.SamplePrograms.ButtonE where
...
buttonE :: IO ()
buttonE = withArduino False "/dev/cu.usbmodem1421" $ do
           let button = lit 2
           let led1 = lit 6
           let led2 = lit 7
