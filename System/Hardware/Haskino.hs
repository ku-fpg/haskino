...
module System.Hardware.Haskino (
  ...
  , lesseqE, greatE, greateqE, eqE, neqE, headE, tailE, nullE, ifBE, fromIntegralE
  -- ** Serial
  ...
  , serialWrite, serialWriteE, serialWriteList, serialWriteListE
  -- ** Debugging
  , debug, debugE, debugListen, die, deframe
  -- ** Compiler
  , compileProgram, compileProgramE
  -- ** Lambda's (will be removed)
  , lamExpr, appExpr, appLambda, remArg, appE, appFE, lamE
  -- ** Recursion
